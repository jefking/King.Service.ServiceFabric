        ...
        private static void Main()
        {
            try
            {
                ...
                using (var fabricRuntime = FabricRuntime.Create())
                {
                    ...
                    fabricRuntime.RegisterServiceType("RecieverType", typeof(Reciever));

                    ServiceEventSource.Current.ServiceTypeRegistered(Process.GetCurrentProcess().Id, typeof(Reciever).Name);
